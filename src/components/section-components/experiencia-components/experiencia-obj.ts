...
export const experienciaCards: CardType = [
  {
    ...
    img: "/assets/img-experiencia/radical.png",
    description:
      "Durante este periodo me dedique a la refactorizacion de un API utilizando ASP.NET, Swagger y SQL" +
      " en donde con ayuda de los principios SOLID y Clean Code me enfoque en corregir la logica, rehaciendo clases y aplicando una estructura de controladores, clases e interfaces limpia " +
