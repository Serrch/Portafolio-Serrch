import { languageObj, frameworkObj } from "./tech-obj";
import TechCards from "./tech-cards";
export default function Stack() {
  return (
    <section
      id="stack"
      className="md:min-h-screen snap-start flex flex-col items-center justify-center pt-8 md:pt-30  border-t"
    >
      <div className="flex flex-col gap-4 max-w-6xl w-full px-4">
        <h1 className="text-4xl font-bold text-start mb-2">Tech Stack</h1>
        <div className="grid grid-rows-3 gap-4 ms-5">
